...
//        Debug.Log(cellPos);
        return new Vector3(cellPos[0] * 10 - minDistance, 0.5f, cellPos[1] * 10 - minDistance);
    }
    /// <summary>
    ...
    private void PlaceMouse()
    {
        ...
        mazeAgent.transform.position = new Vector3(6f, 1.7f, 6f);
    ...
    private void Spawncheese(int count, float cheeseSpeed)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            cheeseObject.transform.position = setRandomPositionCell(cheeseObject.GetComponent<TargetController>().currentCellPosition, mazeAgent.transform.position, 4f, 4f);//+ Vector3.up * 1.1f
